namespace SFA.Apprenticeships.Web.Candidate.UnitTests.Providers.ApplicationProvider
{
    ...
    public class GetApplicationViewModelTests
    {
        ...
        [Test]
        public async Task GetShouldNotCreate()
        {
            var candidateService = new Mock<ICandidateService>();
            await new ApprenticeshipApplicationProviderBuilder().With(candidateService).Build().GetApplicationViewModel(Guid.NewGuid(), ValidVacancyId);
        ...
        public async Task GetNotFound()
        {
            ...
            var viewModel = await new ApprenticeshipApplicationProviderBuilder().With(candidateService)
                .Build()
        ...
        public async Task UnhandledError()
        {
            ...
            var viewModel = await new ApprenticeshipApplicationProviderBuilder().With(candidateService).Build().GetApplicationViewModel(candidateId, ValidVacancyId);
        ...
        [Test]
        public async Task ConvertSavedVacancyToDraftApplication()
        {
            var candidateId = Guid.NewGuid();
            var candidateService = new Mock<ICandidateService>();
            var apprenticeshipVacancyProvider = new Mock<IApprenticeshipVacancyProvider>();
