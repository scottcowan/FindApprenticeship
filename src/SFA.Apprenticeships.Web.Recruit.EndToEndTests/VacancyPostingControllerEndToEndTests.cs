namespace SFA.Apprenticeships.Web.Recruit.EndToEndTests
{
    ...
    public class VacancyPostingControllerEndToEndTests : RecruitWebEndToEndTestsBase
    {
        ...
        private static Vacancy GetCorrectVacancy(int vacancyReferenceNumber, string title, VacancyStatus status = VacancyStatus.Submitted)
        {
            return new Vacancy
            {
                Title = title,
