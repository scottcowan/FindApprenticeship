namespace SFA.Apprenticeships.Web.Manage.UnitTests.Mediators.Vacancy
{
    ...
    public class UpdateVacancyQuestionsViewModelTests
    {
        ...
        public async Task ShouldReturnFailedValidationIfTheViewModelIsNotCorrect()
        {
            ...
            var result = await mediator.UpdateVacancy(vacancy.VacancyQuestionsViewModel);
        ...
        public async Task ShouldReturnInvalidVacancyIfTheVacancyIsNotAvailableToQA()
        {
            ...
            provider.Setup(p => p.UpdateVacancyWithComments(vacancy.VacancyQuestionsViewModel)).Returns(Task.FromResult(qaActionResult));
