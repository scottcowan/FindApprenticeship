...
namespace SFA.DAS.RAA.Api.AcceptanceTests.Steps
{
    ...
    [Binding]
    public class GetPublicVacancySummarySteps
    {
        [When(@"I request page (.*) of the list of (.*) public live vacancy summaries with page size: (.*)")]
        ...
        [Then(@"I see (.*) public vacancy summaries on page (.*) from a total of (.*) and (.*) total pages")]
